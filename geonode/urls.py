...
urlpatterns = patterns('',
                       ...
                       url(r'^handbook/$', TemplateView.as_view(template_name='handbook.html'), name='handbook'),
                       url(r'^statistical/$', TemplateView.as_view(template_name='statistical.html'), name='statistical'),
                       url(r'^factsheets/$', TemplateView.as_view(template_name='factsheets.html'), name='factsheets'),
                       url(r'^gguidelines/$', TemplateView.as_view(template_name='gguidelines.html'), name='gguidelines'),
                       url(r'^experts/$', TemplateView.as_view(template_name='experts.html'), name='experts'),
                       url(r'^learn/$', TemplateView.as_view(template_name='learn.html'), name='learn'),
                       url(r'^edata/$', TemplateView.as_view(template_name='edata.html'), name='edata'),
                       url(r'^termsofuse/$', TemplateView.as_view(template_name='termsofuse.html'), name='edata'),
                       url(r'^gmaps/$', TemplateView.as_view(template_name='gmaps.html'), name='gmaps'),
                       url(r'^statisticaltest/$', TemplateView.as_view(template_name='statisticaltest.html'), name='statisticaltest'),
